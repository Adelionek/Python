...
def login():
    ...
    if form.validate_on_submit():
        ...
        login_user(user, remember=form.remember_me.data) # current user will be set to that user
    ...
    # the login.html page expects form object, so we pass it here
...
def register():
    ...
    # if user register in proper way
    if form.validate_on_submit():
